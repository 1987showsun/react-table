            ...
            <ul>
                {
                    ...
                    displayTextToLowerCase.includes('first') &&
                        <li className={`arrows ${stateCurrent==1? 'disabled':''}`} onClick={handleArrows.bind(this,'first')}>First</li>
                }
                {
                    // 上下頁
                    displayTextToLowerCase.includes('arrows') &&
                        <li className={`arrows prev ${stateCurrent==1? 'disabled':''}`} onClick={handleArrows.bind(this,'prev')}>
                            <i><FontAwesomeIcon icon={faChevronLeft}/></i>PREV
                        </li>
                }
                ...
                }
                {
                    ...
                    displayTextToLowerCase.includes('arrows') &&
                        <li className={`arrows next ${stateCurrent==stateTotalPages? 'disabled':''}`} onClick={handleArrows.bind(this,'next')}>
                            NEXT<i><FontAwesomeIcon icon={faChevronRight}/></i>
                        </li>
                }
                {
                    // 前往最後一頁
                    displayTextToLowerCase.includes('last') &&
                        <li className={`arrows ${stateCurrent==stateTotalPages? 'disabled':''}`} onClick={handleArrows.bind(this,'last')}>Last</li>
                }
            </ul>
        </div>
    );
